...
#
# Output: build/Noos Bridge.app
#
# Env vars:
#   SIGN_IDENTITY      — codesigning identity (default: IdeaFlow Developer ID)
#   BUNDLE_ID          — CFBundleIdentifier (default: com.ideaflow.noos-bridge)
...
#
# After this script: drag the .app to /Applications and launch it.
...
BUNDLE_ID="${BUNDLE_ID:-com.ideaflow.noos-bridge}"
...
<dict>
  ...
  <!-- Custom URL scheme for pairing callback. The broker auth page redirects
       back to noos-bridge://auth-callback?token=... -->
  ...
  <key>NSCalendarsFullAccessUsageDescription</key>
    <string>Noos Bridge lets paired remote agents search your calendar events when you ask questions about your schedule.</string>
  <key>NSRemindersFullAccessUsageDescription</key>
    <string>Noos Bridge lets paired remote agents search your reminders when you ask questions about your tasks.</string>
  <key>NSAppleEventsUsageDescription</key>
    <string>Noos Bridge uses AppleScript to send iMessages on your behalf when you explicitly ask a paired remote agent to.</string>
</dict>
</plist>
PLIST
